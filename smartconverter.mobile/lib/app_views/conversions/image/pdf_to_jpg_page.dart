...
class _PdfToJpgImagePageState extends State<PdfToJpgImagePage> {
  ...
  Future<void> _convertPdfToJpg() async {
    ...
    setState(() {
      _isConverting = true;
      _statusMessage = 'Converting PDF to JPG images...';
    });
    ...
    try {
      ...
      final result = await _service.convertPdfToJpg(
        _selectedFile!,
  ...
  Future<void> _saveImagesLocally() async {
    ...
    try {
      final baseDir = widget.useImageCategoryStorage
          ? await _getImageCategoryDirectory('pdf_to_jpg')
          : await FileManager.getPdfToJpgImagesDirectory();
