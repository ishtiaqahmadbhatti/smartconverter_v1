...
class _JpgToPdfPageState extends State<JpgToPdfPage> {
    ...
    try {
      ...
      if (response.statusCode == 200 && response.data['success'] == true) {
        ...
        setState(() {
          ...
          _statusMessage = 'JPG converted to PDF successfully!';
        });
  ...
  Future<void> _savePdfFile() async {
    ...
    try {
      // Use structured path: SmartConverter/ImageConversion/jpg-to-pdf
      ...
      final targetDir = Directory('${imageRoot.path}/jpg-to-pdf');
          ...
          Expanded(
            child: Column(
              ...
              children: const [
                ...
                SizedBox(height: 6),
                Text(
                  'Convert JPG image into a PDF document.',
                  style: TextStyle(
                    color: AppColors.textPrimary,
                    fontSize: 13,
                    height: 1.4,
