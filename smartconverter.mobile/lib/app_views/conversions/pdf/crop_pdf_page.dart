...
class _CropPdfPageState extends State<CropPdfPage> with AdHelper {
  ...
  Future<void> _cropPdf() async {
    ...
    final adWatched = await showRewardedAdGate(toolName: 'Crop PDF');
    if (!adWatched) {
      setState(() {
        _isProcessing = false;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: const Text('Crop PDF', style: TextStyle(color: AppColors.textPrimary, fontWeight: FontWeight.w600)),
        leading: IconButton(
          ...
          Expanded(
            child: Column(
              ...
              children: const [
                ...
                SizedBox(height: 6),
                Text(
                  'Crop your PDF documents to specific dimensions or remove unwanted margins.',
                  style: TextStyle(
                    color: AppColors.textPrimary,
                    fontSize: 13,
                    height: 1.4,
  ...
  Widget _buildCropButton() {
    ...
    return SizedBox(
      ...
      child: ElevatedButton(
        onPressed: canConvert ? _cropPdf : null,
        style: ElevatedButton.styleFrom(
          backgroundColor: AppColors.primaryBlue,
          foregroundColor: AppColors.textPrimary,
