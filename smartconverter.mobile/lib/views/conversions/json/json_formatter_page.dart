    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 12),
          _buildInstructionStep('1', 'Choose input method: Upload file or paste JSON'),
          const SizedBox(height: 8),
          _buildInstructionStep('2', 'Select indentation size (2, 3, or 4 spaces)'),
          const SizedBox(height: 8),
          _buildInstructionStep('3', 'Tap "Format JSON" to beautify'),
          const SizedBox(height: 8),
          _buildInstructionStep('4', 'Copy formatted JSON or save/share file'),
        ],
      ),
    );
  }
