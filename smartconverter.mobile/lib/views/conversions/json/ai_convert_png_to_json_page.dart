...
class _AiConvertPngToJsonPageState extends State<AiConvertPngToJsonPage> with AdHelper<AiConvertPngToJsonPage> {
  ...
  Future<void> _convertImageToJson() async {
    ...
    try {
      ...
      final result = await _service.convertPngToJson(
        _selectedFile!,
  ...
  Future<void> _saveJsonFile() async {
    ...
    try {
      final directory = await FileManager.getJsonPngToJsonDirectory();
          ...
          Expanded(
            child: Column(
              ...
              children: const [
                ...
                SizedBox(height: 6),
                Text(
                  'Extract text and structured data from PNG images using advanced OCR technology.',
                  style: TextStyle(
                    color: AppColors.textPrimary,
                    fontSize: 13,
                    height: 1.4,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildInstructionStep('1', 'Select a PNG file (.png extension)'),
