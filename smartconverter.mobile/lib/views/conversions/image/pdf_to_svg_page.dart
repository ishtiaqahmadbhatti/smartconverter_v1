...
class _PdfToSvgImagePageState extends State<PdfToSvgImagePage> {
  ...
  Future<void> _convertPdfToSvg() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            'Downloaded ${result.files.length} SVG files (folder: ${result.folderName}).',
          ),
  ...
  Widget _buildInstructions() {
    final steps = [
      ...
      'Tap the convert button to export every page as SVG.',
      'Save the files locally or share them instantly.',
    ];
