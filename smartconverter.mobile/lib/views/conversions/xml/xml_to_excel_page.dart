...
class _XmlToExcelPageState extends State<XmlToExcelPage> {
    ...
    try {
      ...
      if (response.statusCode == 200 && response.data['success'] == true) {
        ...
        setState(() {
          ...
          _statusMessage = 'XML converted to Excel successfully!';
        });

        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Excel file ready: $outputFilename'),
  ...
  Future<void> _saveExcelFile() async {
    ...
    try {
      final targetDir = await FileManager.getXmlToExcelDirectory();
