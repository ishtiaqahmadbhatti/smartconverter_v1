        ...
        children: [
          ...
          Text(
            _targetDirectoryPath != null
                ...
                : 'Will save under: Documents/SmartConverter/PDFConversions/RepairPDF',
            ...
            children: [
              Expanded(
                child: ElevatedButton(
                  onPressed: (_selectedFile == null || _isProcessing) ? null : _repairPdf,
                  style: ElevatedButton.styleFrom(backgroundColor: AppColors.primaryBlue),
                  child: Text(_isProcessing ? 'Processing…' : 'Repair', style: const TextStyle(color: Colors.white)),
                ),
              ),
