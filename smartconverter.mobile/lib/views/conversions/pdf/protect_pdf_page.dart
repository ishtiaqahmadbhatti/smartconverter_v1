        ...
        children: [
          ...
          Text(
            _targetDirectoryPath != null
                ...
                : 'Will save under: Documents/SmartConverter/PDFConversions/ProtectPDF',
            ...
            children: [
              Expanded(
                child: ElevatedButton(
                  onPressed: (_selectedFile == null || _isProcessing) ? null : _protectPdf,
                  style: ElevatedButton.styleFrom(backgroundColor: AppColors.primaryBlue),
                  child: Text(_isProcessing ? 'Processing…' : 'Protect', style: const TextStyle(color: Colors.white)),
                ),
              ),
