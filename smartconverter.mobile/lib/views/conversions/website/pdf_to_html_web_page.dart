...
class _PdfToHtmlWebPageState extends State<PdfToHtmlWebPage> {
  ...
  String _statusMessage = 'Select a PDF file to convert.';
  ...
  Future<void> _saveFile() async {
    ...
    try {
      final directory = await FileManager.getWebsitePdfToHtmlDirectory();
          ...
          const Expanded(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 6),
                Text(
                  'Extract text from PDF documents as HTML',
                  style: TextStyle(
                    color: AppColors.textPrimary,
                    fontSize: 13,
                    height: 1.4,
  ...
  Widget _buildFileNameField() {
    final hintText = _suggestedBaseName ?? 'pdf_html';
    return TextField(
