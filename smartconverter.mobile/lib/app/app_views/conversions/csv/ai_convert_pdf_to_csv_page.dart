...
class AiConvertPdfToCsvPage extends StatefulWidget {
  const AiConvertPdfToCsvPage({super.key});

  @override
  State<AiConvertPdfToCsvPage> createState() => _AiConvertPdfToCsvPageState();
}

class _AiConvertPdfToCsvPageState extends State<AiConvertPdfToCsvPage> with AdHelper, ConversionMixin {
  ...
  @override
  // Use CSV Category specific directory
  Future<Directory> get saveDirectory => FileManager.getPdfToCsvDirectoryFromCsvCategory();
            ...
            children: [
              ...
              if (model.selectedFile != null)
                ConversionSelectedFileCardWidget(
                  ...
                  fileSize: model.selectedFile!.existsSync() ? formatBytes(model.selectedFile!.lengthSync()) : '0 B',
