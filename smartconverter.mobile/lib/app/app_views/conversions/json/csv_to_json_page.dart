...
class _CsvToJsonPageState extends State<CsvToJsonPage>
  ...
  @override
  String get conversionToolName => 'CsvToJson';

  // Not in mixin, no @override
  String get conversionTitle => 'Convert CSV to JSON';
  String get conversionDescription => 'Transform CSV files into JSON format.';
  IconData get iconA => Icons.grid_on;
  ...
  Future<ImageToPdfResult?> performConversion(
    ...
    return service.convertCsvToJson(
      file!,
