...
class _AiConvertJpgToJsonPageState extends State<AiConvertJpgToJsonPage>
  ...
  @override
  String get conversionToolName => 'AiConvertJpgToJson';

  // Not in mixin
  String get conversionTitle => 'Convert JPG to JSON';
  String get conversionDescription => 'Use AI to extract data from JPG to JSON.';
  ...
  Future<Directory> get saveDirectory =>
      FileManager.getAiConvertJpgToJsonDirectory();
  ...
  Future<ImageToPdfResult?> performConversion(
    ...
    return service.convertJpgToJson(
      file!,
