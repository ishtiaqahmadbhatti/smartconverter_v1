...
class _JsonObjectsToCsvPageState extends State<JsonObjectsToCsvPage>
  ...
  @override
  String get conversionToolName => 'JsonObjectsToCsv';

  // Not in mixin
  String get conversionTitle => 'Extract Objects to CSV';
  String get conversionDescription => 'Extract list of objects from JSON to CSV format.';
  IconData get iconA => Icons.data_array;
  IconData get iconB => Icons.grid_on;
  String get buttonLabel => 'Extract to CSV';
  ...
  Future<Directory> get saveDirectory =>
      FileManager.getJsonObjectsToCsvDirectory();
