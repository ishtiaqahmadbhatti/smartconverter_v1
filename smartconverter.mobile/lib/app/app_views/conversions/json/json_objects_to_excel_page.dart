...
class _JsonObjectsToExcelPageState extends State<JsonObjectsToExcelPage>
  ...
  @override
  String get conversionToolName => 'JsonObjectsToExcel';

  // Not in mixin
  String get conversionTitle => 'Extract Objects to Excel';
  String get conversionDescription => 'Extract list of objects from JSON to Excel format.';
  IconData get iconA => Icons.data_array;
  IconData get iconB => Icons.table_chart;
  String get buttonLabel => 'Extract to Excel';
  ...
  Future<Directory> get saveDirectory =>
      FileManager.getJsonObjectsToExcelDirectory();
