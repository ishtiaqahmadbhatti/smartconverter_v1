...
class _HtmlToPdfPageState extends State<HtmlToPdfPage>
  ...
  @override
  Future<Directory> get saveDirectory async => await FileManager.getHtmlToPdfDirectory();
  ...
  void initState() {
    ...
    _htmlContentController.addListener(() => setState(() {}));
    _cssContentController.addListener(() => setState(() {}));
  }
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                if ((_tabController.index == 0 && model.selectedFile != null) || (_tabController.index == 1 && _htmlContentController.text.isNotEmpty)) ...[
