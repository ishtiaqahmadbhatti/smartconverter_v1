...
class _AiPdfToJsonPageState extends State<AiPdfToJsonPage> with AdHelper, ConversionMixin {
  ...
  @override
  String get conversionToolName => 'AI: PDF to JSON';
  ...
  @override
  Future<Directory> get saveDirectory => FileManager.getPdfToJsonDirectory(); // Consistently uses JSONConversion/pdf-to-json

  @override
  Future<ImageToPdfResult?> performConversion(File? file, String? outputName) {
    if (file == null) throw Exception('File is null');
    return service.convertPdfToJson(file, outputFilename: outputName);
  }
            ...
            child: Column(
              children: [
                const ConversionHeaderCardWidget(
                  title: 'AI: Convert PDF to JSON',
                  description: 'Extract structured data from your PDF documents into clean JSON files for APIs, automation, or analysis.',
