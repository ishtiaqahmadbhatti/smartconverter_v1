...
class _PdfToPngPageState extends State<PdfToPngPage> with AdHelper, ConversionMixin {
  ...
  @override
  Future<Directory> get saveDirectory => FileManager.getPdfToPngImagesDirectory();

  @override
  Future<dynamic> performConversion(File? file, String? outputName) {
    if (file == null) throw Exception('File is null');
    return service.convertPdfToPng(file, outputFilename: outputName);
  }
            ...
            child: Column(
              children: [
                const ConversionHeaderCardWidget(
                  ...
                  description: 'Convert PDF pages into high-quality PNG images with transparency support.',
