...
class AiPdfToExcelPage extends StatefulWidget {
  const AiPdfToExcelPage({super.key});

  @override
  State<AiPdfToExcelPage> createState() => _AiPdfToExcelPageState();
}

class _AiPdfToExcelPageState extends State<AiPdfToExcelPage> with AdHelper, ConversionMixin {
  ...
  @override
  String get conversionToolName => 'AI PDF-to-Excel';
  ...
  Future<ImageToPdfResult?> performConversion(File? file, String? outputName) {
    ...
    // Using standard PDF to Excel conversion for now
