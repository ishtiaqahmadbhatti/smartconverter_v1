...
class PdfToFbzPage extends StatefulWidget {
  const PdfToFbzPage({super.key});

  @override
  State<PdfToFbzPage> createState() => _PdfToFbzPageState();
}

class _PdfToFbzPageState extends State<PdfToFbzPage> with AdHelper, ConversionMixin {
  ...
  @override
  String get conversionToolName => 'Convert Pdf To Fbz';

  @override
  String get fileTypeLabel => 'PDF';

  @override
  String get targetExtension => 'fbz';

  @override
  List<String> get allowedExtensions => ['pdf'];

  @override
  Future<Directory> get saveDirectory => FileManager.getPdfToFbzDirectory();
  ...
  Future<ImageToPdfResult?> performConversion(File? file, String? outputName) {
    ...
    return service.convertEbook(
      ...
      endpoint: ApiConfig.ebookPdfToFbzEndpoint,
            ...
            child: Column(
              children: [
                ConversionHeaderCardWidget(
                  ...
                  description: 'Transform PDF documents into FBZ eBooks.',
