...
class PdfToMobiPage extends StatefulWidget {
  const PdfToMobiPage({super.key});

  @override
  State<PdfToMobiPage> createState() => _PdfToMobiPageState();
}

class _PdfToMobiPageState extends State<PdfToMobiPage> with AdHelper, ConversionMixin {
  ...
  @override
  String get conversionToolName => 'Convert Pdf To Mobi';
  ...
  @override
  Future<Directory> get saveDirectory => FileManager.getPdfToMobiDirectory();
  ...
  Future<ImageToPdfResult?> performConversion(File? file, String? outputName) {
    ...
    return service.convertEbook(
      ...
      endpoint: ApiConfig.ebookPdfToMobiEndpoint,
            ...
            child: Column(
              children: [
                ConversionHeaderCardWidget(
                  ...
                  description: 'Transform PDF documents into MOBI eBooks.',
