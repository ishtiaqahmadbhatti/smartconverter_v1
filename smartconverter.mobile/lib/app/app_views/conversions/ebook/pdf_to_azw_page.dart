...
class PdfToAzwPage extends StatefulWidget {
  const PdfToAzwPage({super.key});

  @override
  State<PdfToAzwPage> createState() => _PdfToAzwPageState();
}

class _PdfToAzwPageState extends State<PdfToAzwPage> with AdHelper, ConversionMixin {
  ...
  @override
  String get conversionToolName => 'Convert Pdf To Azw';

  @override
  String get fileTypeLabel => 'PDF';

  @override
  String get targetExtension => 'azw';

  @override
  List<String> get allowedExtensions => ['pdf'];

  @override
  Future<Directory> get saveDirectory => FileManager.getPdfToAzwDirectory();
  ...
  Future<ImageToPdfResult?> performConversion(File? file, String? outputName) {
    ...
    return service.convertEbook(
      ...
      endpoint: ApiConfig.ebookPdfToAzwEndpoint,
            ...
            child: Column(
              children: [
                ConversionHeaderCardWidget(
                  ...
                  description: 'Transform PDF documents into AZW eBooks.',
