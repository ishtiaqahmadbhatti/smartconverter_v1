...
class EpubToPdfPage extends StatefulWidget {
  const EpubToPdfPage({super.key});

  @override
  State<EpubToPdfPage> createState() => _EpubToPdfPageState();
}

class _EpubToPdfPageState extends State<EpubToPdfPage> with AdHelper, ConversionMixin {
  ...
  @override
  String get conversionToolName => 'Convert Epub To Pdf';
  ...
  @override
  Future<Directory> get saveDirectory => FileManager.getEpubToPdfDirectory();
  ...
  Future<ImageToPdfResult?> performConversion(File? file, String? outputName) {
    ...
    return service.convertEbook(
      ...
      endpoint: ApiConfig.ebookEpubToPdfEndpoint,
            ...
            child: Column(
              children: [
                ConversionHeaderCardWidget(
                  ...
                  description: 'Transform ePUB eBooks into PDF documents.',
