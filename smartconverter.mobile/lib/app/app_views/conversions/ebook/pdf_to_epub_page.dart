...
class PdfToEpubPage extends StatefulWidget {
  const PdfToEpubPage({super.key});

  @override
  State<PdfToEpubPage> createState() => _PdfToEpubPageState();
}

class _PdfToEpubPageState extends State<PdfToEpubPage> with AdHelper, ConversionMixin {
  ...
  @override
  String get conversionToolName => 'Convert Pdf To Epub';
  ...
  @override
  Future<Directory> get saveDirectory => FileManager.getPdfToEpubDirectory();
  ...
  Future<ImageToPdfResult?> performConversion(File? file, String? outputName) {
    ...
    return service.convertEbook(
      ...
      endpoint: ApiConfig.ebookPdfToEpubEndpoint,
            ...
            child: Column(
              children: [
                ConversionHeaderCardWidget(
                  ...
                  description: 'Transform PDF documents into ePUB eBooks.',
