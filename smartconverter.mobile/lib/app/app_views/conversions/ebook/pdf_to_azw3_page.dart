...
class PdfToAzw3Page extends StatefulWidget {
  const PdfToAzw3Page({super.key});

  @override
  State<PdfToAzw3Page> createState() => _PdfToAzw3PageState();
}

class _PdfToAzw3PageState extends State<PdfToAzw3Page> with AdHelper, ConversionMixin {
  ...
  @override
  String get conversionToolName => 'Convert Pdf To Azw3';

  @override
  String get fileTypeLabel => 'PDF';

  @override
  String get targetExtension => 'azw3';

  @override
  List<String> get allowedExtensions => ['pdf'];

  @override
  Future<Directory> get saveDirectory => FileManager.getPdfToAzw3Directory();
  ...
  Future<ImageToPdfResult?> performConversion(File? file, String? outputName) {
    ...
    return service.convertEbook(
      ...
      endpoint: ApiConfig.ebookPdfToAzw3Endpoint,
            ...
            child: Column(
              children: [
                ConversionHeaderCardWidget(
                  ...
                  description: 'Transform PDF documents into AZW3 eBooks.',
