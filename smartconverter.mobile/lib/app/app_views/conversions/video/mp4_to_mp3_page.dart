...
class _Mp4ToMp3PageState extends State<Mp4ToMp3Page> with AdHelper, ConversionMixin {
  final ConversionModel _model = ConversionModel(statusMessage: 'Select an MP4 file to begin.');
  ...
  @override
  List<String> get allowedExtensions => ['mp4'];

  @override
  Future<Directory> get saveDirectory => FileManager.getMp4ToMp3VideoDirectory();
  ...
  Future<dynamic> performConversion(File? file, String? outputName) {
    ...
    return service.convertEbook(
      ...
      endpoint: ApiConfig.videoMp4ToMp3Endpoint,
