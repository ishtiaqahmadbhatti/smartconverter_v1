...
class _SrtToTextPageState extends State<SrtToTextPage> 
  ...
  @override
  String get conversionToolName => 'SRT-to-Text';
  
  @override
  Future<Directory> get saveDirectory => FileManager.getSrtToTextSubtitleDirectory();
                ...
                child: Column(
                  ...
                  children: [
                    ConversionHeaderCardWidget(
                      title: 'SRT to Text',
                      description: 'Convert subtitle captions from .srt to a plain .txt file',
                      iconSource: Icons.subtitles_outlined,
