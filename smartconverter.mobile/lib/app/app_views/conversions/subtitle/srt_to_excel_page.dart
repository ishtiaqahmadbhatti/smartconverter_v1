...
class _SrtToExcelPageState extends State<SrtToExcelPage> 
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('SRT to Excel', style: TextStyle(color: AppColors.textPrimary)),
                ...
                child: Column(
                  ...
                  children: [
                    ConversionHeaderCardWidget(
                      title: 'Convert SRT to Excel',
                      description: 'Convert subtitle captions from .srt to a structured .xlsx file',
                      iconSource: Icons.subtitles_outlined, // SRT icon
                      iconTarget: Icons.table_view_outlined, // Excel/Table icon
                    ),
