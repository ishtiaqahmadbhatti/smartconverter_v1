...
class FlacToMp3Page extends StatefulWidget {
  const FlacToMp3Page({super.key});

  @override
  State<FlacToMp3Page> createState() => _FlacToMp3PageState();
}

class _FlacToMp3PageState extends State<FlacToMp3Page> with AdHelper, ConversionMixin {
  final ConversionModel _model = ConversionModel(statusMessage: 'Select a FLAC file to convert to MP3.');
  ...
  @override
  String get conversionToolName => 'Convert FLAC to MP3';

  @override
  String get fileTypeLabel => 'FLAC';

  @override
  String get targetExtension => 'mp3';

  @override
  List<String> get allowedExtensions => ['flac'];

  @override
  Future<Directory> get saveDirectory => FileManager.getFlacToMp3Directory();
  ...
  Future<dynamic> performConversion(File? file, String? outputName) {
    ...
    return service.convertEbook(
        ...
        endpoint: ApiConfig.audioFlacToMp3Endpoint,
