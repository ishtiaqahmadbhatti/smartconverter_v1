...
class _CsvToXmlFromXmlCategoryPageState extends State<CsvToXmlFromXmlCategoryPage> with AdHelper<CsvToXmlFromXmlCategoryPage> {
  ...
  Future<void> _saveXmlFile() async {
    ...
    try {
      final directory = await FileManager.getCsvToXmlDirectory();
