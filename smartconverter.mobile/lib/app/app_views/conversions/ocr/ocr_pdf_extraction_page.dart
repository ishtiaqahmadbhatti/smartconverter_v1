...
class OcrPdfExtractionPage extends StatefulWidget {
  const OcrPdfExtractionPage({super.key});

  @override
  State<OcrPdfExtractionPage> createState() => _OcrPdfExtractionPageState();
}

class _OcrPdfExtractionPageState extends State<OcrPdfExtractionPage>
  ...
  final ConversionModel model = ConversionModel(
    statusMessage: 'Select a PDF file to extract text via OCR.',
  );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('OCR PDF Extraction', style: TextStyle(color: AppColors.textPrimary)),
