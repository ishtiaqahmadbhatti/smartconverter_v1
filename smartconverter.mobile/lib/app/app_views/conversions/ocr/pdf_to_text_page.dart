...
class _PdfToTextPageState extends State<PdfToTextPage>
  ...
  final ConversionModel model = ConversionModel(
    statusMessage: 'Select a PDF file to extract text.',
  );
  ...
  @override
  String get conversionToolName => 'PdfToText';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('PDF to Text (OCR)', style: TextStyle(color: AppColors.textPrimary)),
                  ...
                  child: Column(
                    children: [
                      const ConversionHeaderCardWidget(
                        title: 'PDF to Text',
                        description: 'Extract text from any PDF document using OCR',
