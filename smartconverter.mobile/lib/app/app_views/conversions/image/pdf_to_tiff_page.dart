...
class _PdfToTiffImagePageState extends State<PdfToTiffImagePage> with AdHelper, ConversionMixin {
  ...
  Future<PdfToImagesResult?> performConversion(File? file, String? outputName) async {
    ...
    return await service.convertPdfToTiff(file, outputFilename: outputName);
  }
            ...
            child: Column(
              ...
              children: [
                const ConversionHeaderCardWidget(
                  ...
                  description: 'Convert each page of your PDF into high-quality TIFF images.',
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      '${result.files.length} TIFF images generated',
