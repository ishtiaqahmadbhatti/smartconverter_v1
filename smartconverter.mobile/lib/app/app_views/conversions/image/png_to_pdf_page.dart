...
class _PngToPdfPageState extends State<PngToPdfPage> {
    ...
    try {
      ...
      if (response.statusCode == 200 && response.data['success'] == true) {
        ...
        setState(() {
          ...
          _statusMessage = 'PNG converted to PDF successfully!';
        });
  ...
  Future<void> _savePdfFile() async {
    ...
    try {
      // Use structured path: SmartConverter/ImageConversion/png-to-pdf
      ...
      final targetDir = Directory('${imageRoot.path}/png-to-pdf');
          ...
          Expanded(
            child: Column(
              ...
              children: const [
                ...
                SizedBox(height: 6),
                Text(
                  'Convert PNG image into a PDF document.',
                  style: TextStyle(
                    color: AppColors.textPrimary,
                    fontSize: 13,
                    height: 1.4,
  ...
  // Reuse ActionButtons, FileCard, FileNameField, ConvertButton, StatusMessage, ResultCard from previous.
  // ... (I will include the full code in the tool call)
  
  Widget _buildActionButtons() {
     // ... same as JpgToPdfPage with Png text ...
      return Row(
      children: [
        Expanded(
