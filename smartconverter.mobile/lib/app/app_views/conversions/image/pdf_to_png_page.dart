...
class _PdfToPngImagePageState extends State<PdfToPngImagePage> with AdHelper, ConversionMixin {
  ...
  @override
  String get conversionToolName => 'PDF to PNG';
  @override
  ...
  Future<Directory> get saveDirectory async {
    ...
    final toolDir = Directory('${imageRoot.path}/pdf-to-png');
  ...
  Future<PdfToImagesResult?> performConversion(File? file, String? outputName) async {
    ...
    return await service.convertPdfToPng(file, outputFilename: outputName);
  }
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      '${result.files.length} PNG images generated',
