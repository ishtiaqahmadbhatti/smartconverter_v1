...
class _WebsiteToJpgPageState extends State<WebsiteToJpgPage>
  ...
  @override
  String get conversionToolName => 'WebsiteToJpg';

  @override
  String get convertingMessage => 'Converting to JPG...';

  @override
  String get successMessage => 'JPG ready!';

  @override
  bool get requiresInputFile => false;

  @override
  Future<Directory> get saveDirectory => FileManager.getWebsiteToJpgDirectory();
  ...
  Future<ImageToPdfResult?> performConversion(File? file, String? outputName) async {
    ...
    return await service.convertWebsiteToJpg(
      url,
            ...
            child: Column(
              ...
              children: [
                const ConversionHeaderCardWidget(
                  title: 'Convert Website to JPG',
                  description: 'Capture full-page screenshots of websites as JPG images',
                ...
                if (model.conversionResult != null) ...[
                  const SizedBox(height: 20),
                  if (model.savedFilePath == null) ConversionFileSaveCardWidget(fileName: model.conversionResult!.fileName, isSaving: model.isSaving, onSave: saveResult, title: 'JPG Image Ready',) else ConversionResultCardWidget(savedFilePath: model.savedFilePath!, onShare: shareFile,)
                ],
              ],
            ),
          ),
