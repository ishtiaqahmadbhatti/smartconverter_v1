...
class SrtToExcelOfficePage extends StatefulWidget {
  const SrtToExcelOfficePage({super.key});

  @override
  State<SrtToExcelOfficePage> createState() => _SrtToExcelOfficePageState();
}

class _SrtToExcelOfficePageState extends State<SrtToExcelOfficePage> with AdHelper, ConversionMixin {
  final ConversionModel _model = ConversionModel(statusMessage: 'Select an SRT subtitle file to begin.');
  ...
  @override
  String get conversionToolName => 'SRT to Excel';
  ...
  @override
  Future<Directory> get saveDirectory => FileManager.getOfficeSrtToExcelDirectory();
