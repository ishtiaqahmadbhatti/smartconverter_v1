...
class ExcelToPdfOfficePage extends StatefulWidget {
  const ExcelToPdfOfficePage({super.key});

  @override
  State<ExcelToPdfOfficePage> createState() => _ExcelToPdfOfficePageState();
}

class _ExcelToPdfOfficePageState extends State<ExcelToPdfOfficePage> with AdHelper, ConversionMixin {
  ...
  @override
  Future<Directory> get saveDirectory => FileManager.getOfficeExcelToPdfDirectory();

  @override
  Future<ImageToPdfResult?> performConversion(File? file, String? outputName) {
    if (file == null) throw Exception('File is null');
    // Note: service method currently doesn't accept outputName, but local saving uses controller text.
