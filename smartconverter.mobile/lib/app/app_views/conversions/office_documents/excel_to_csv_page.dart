...
class ExcelToCsvOfficePage extends StatefulWidget {
  const ExcelToCsvOfficePage({super.key});

  @override
  State<ExcelToCsvOfficePage> createState() => _ExcelToCsvOfficePageState();
}

class _ExcelToCsvOfficePageState extends State<ExcelToCsvOfficePage> with AdHelper, ConversionMixin {
  ...
  @override
  Future<Directory> get saveDirectory => FileManager.getOfficeExcelToCsvDirectory();

  @override
  Future<ImageToPdfResult?> performConversion(File? file, String? outputName) {
    if (file == null) throw Exception('File is null');
    return service.convertExcelToCsv(file);
  }
