...
class ExcelToSrtOfficePage extends StatefulWidget {
  const ExcelToSrtOfficePage({super.key});

  @override
  State<ExcelToSrtOfficePage> createState() => _ExcelToSrtOfficePageState();
}

class _ExcelToSrtOfficePageState extends State<ExcelToSrtOfficePage> with AdHelper, ConversionMixin {
  ...
  @override
  Future<Directory> get saveDirectory => FileManager.getOfficeExcelToSrtDirectory();
