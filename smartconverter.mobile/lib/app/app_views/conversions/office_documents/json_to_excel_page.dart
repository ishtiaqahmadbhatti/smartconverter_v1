...
class JsonToExcelOfficePage extends StatefulWidget {
  const JsonToExcelOfficePage({super.key});

  @override
  State<JsonToExcelOfficePage> createState() => _JsonToExcelOfficePageState();
}

class _JsonToExcelOfficePageState extends State<JsonToExcelOfficePage> with AdHelper, ConversionMixin {
  ...
  @override
  String get conversionToolName => 'JSON to Excel';
  ...
  @override
  Future<Directory> get saveDirectory => FileManager.getOfficeJsonToExcelDirectory();

  @override
  Future<ImageToPdfResult?> performConversion(File? file, String? outputName) {
    if (file == null) throw Exception('File is null');
    return service.convertJsonToExcel(file, outputFilename: outputName);
  }
