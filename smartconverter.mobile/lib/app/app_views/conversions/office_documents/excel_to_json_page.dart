...
class ExcelToJsonOfficePage extends StatefulWidget {
  const ExcelToJsonOfficePage({super.key});

  @override
  State<ExcelToJsonOfficePage> createState() => _ExcelToJsonOfficePageState();
}

class _ExcelToJsonOfficePageState extends State<ExcelToJsonOfficePage> with AdHelper, ConversionMixin {
  ...
  @override
  String get conversionToolName => 'Excel to JSON';
  ...
  @override
  Future<Directory> get saveDirectory => FileManager.getOfficeExcelToJsonDirectory();

  @override
  Future<ImageToPdfResult?> performConversion(File? file, String? outputName) {
    if (file == null) throw Exception('File is null');
    return service.convertExcelToJson(file, outputFilename: outputName);
  }
