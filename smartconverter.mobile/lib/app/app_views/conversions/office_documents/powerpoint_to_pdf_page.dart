...
class PowerPointToPdfOfficePage extends StatefulWidget {
  const PowerPointToPdfOfficePage({super.key});

  @override
  State<PowerPointToPdfOfficePage> createState() => _PowerPointToPdfOfficePageState();
}

class _PowerPointToPdfOfficePageState extends State<PowerPointToPdfOfficePage> with AdHelper, ConversionMixin {
  ...
  @override
  String get conversionToolName => 'PowerPoint to PDF';
  ...
  @override
  Future<Directory> get saveDirectory => FileManager.getOfficePowerPointToPdfDirectory();
