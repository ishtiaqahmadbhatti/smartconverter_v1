...
class ExcelToHtmlOfficePage extends StatefulWidget {
  const ExcelToHtmlOfficePage({super.key});

  @override
  State<ExcelToHtmlOfficePage> createState() => _ExcelToHtmlOfficePageState();
}

class _ExcelToHtmlOfficePageState extends State<ExcelToHtmlOfficePage> with AdHelper, ConversionMixin {
  ...
  @override
  String get conversionToolName => 'Excel to HTML';
  ...
  @override
  Future<Directory> get saveDirectory => FileManager.getOfficeExcelToHtmlDirectory();

  @override
  Future<ImageToPdfResult?> performConversion(File? file, String? outputName) {
    if (file == null) throw Exception('File is null');
    return service.convertExcelToHtml(file, outputFilename: outputName);
  }
