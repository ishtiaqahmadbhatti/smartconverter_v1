...
class WordToTextOfficePage extends StatefulWidget {
  const WordToTextOfficePage({super.key});

  @override
  State<WordToTextOfficePage> createState() => _WordToTextOfficePageState();
}

class _WordToTextOfficePageState extends State<WordToTextOfficePage> with AdHelper, ConversionMixin {
  ...
  @override
  Future<Directory> get saveDirectory => FileManager.getOfficeWordToTextDirectory();
