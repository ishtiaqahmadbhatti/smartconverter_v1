...
@Component({
  ...
  templateUrl: './pdf-to-png.component.html',
  styleUrl: './pdf-to-png.component.css',
  standalone: true
})
export class PdfToPngComponent {
  ...
  convert(): void {
    ...
    this.pdfService.ConvertFile('pdf-to-png', this.selectedFile, this.outputFilename)
      .subscribe({
